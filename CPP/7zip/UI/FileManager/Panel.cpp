...
void CPanel::AddToArchive()
{
  ...
  //::MessageBoxW(NULL, (LPCWSTR)L"AddToArchive", (LPCWSTR)L"mooo", MB_OK);
  ...
  //::MessageBoxW(NULL, (LPCWSTR)L"AddToArchive2", (LPCWSTR)L"mooo", MB_OK);
  HRESULT res = CompressFiles(destCurDirPrefix, archiveName, L"", names, false, true, false);
  //::MessageBoxW(NULL, (LPCWSTR)L"AddToArchive3", (LPCWSTR)L"mooo", MB_OK);
  if (res != S_OK)
  {
